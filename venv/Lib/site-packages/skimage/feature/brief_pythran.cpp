...
#include <pythonic\include\types\int32.hpp>
#include <pythonic\include\types\uint8.hpp>
#include <pythonic\include\types\numpy_texpr.hpp>
...
#include <pythonic\types\ndarray.hpp>
#include <pythonic\types\int32.hpp>
#include <pythonic\types\int64.hpp>
#include <pythonic\types\uint8.hpp>
...
namespace __pythran_brief_cy
{
  ...
  {
    {
      long  __target1470012993736 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, pos0));
      for (long  p=0L; p < __target1470012993736; p += 1L)
      {
        ...
        {
          long  __target1470013070536 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, keypoints));
          for (long  k=0L; k < __target1470013070536; k += 1L)
          {
